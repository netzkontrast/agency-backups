...
SPEC_MD_CONTENT = """# Narrative Context Protocol — Specification for AI-Agent-Driven Novel Co-Authoring
...
with open("/tmp/SPEC.md", "w") as f:
    f.write(SPEC_MD_CONTENT)

with open("/tmp/ARTIFACTS.md", "w") as f:
    f.write("""
