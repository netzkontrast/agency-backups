...
type: note
status: active
slug: prompt-engineering-principle-mechanizability-research-prompt
summary: "Snapshot of the rendered research prompt that drove the per-principle mechanizability assessment of PROMPT.md §5.1–§5.7. Reference copy of `/prompts/research-prompt-engineering-principle-mechanizability/prompt.md`; the canonical executable prompt lives there."
created: 2026-05-06
updated: 2026-05-07
---
...
You are the **main-agent** dispatched to execute subtask ST-1 of [Task prompt-spec-integration](../../tasks/034-prompt-spec-integration/task.md). Your remit is bounded by the Acceptance Criteria in [`brief.md`](../../prompts/research-prompt-engineering-principle-mechanizability/brief.md); you MUST NOT expand scope beyond those criteria without surfacing the divergence in `friction-log.md`.
...
- All `/prompts/<slug>/prompt.md` files (~72 active at execution time).
- [`skills/research-prompt-optimizer/SKILL.md`](../../skills/research-prompt-optimizer/SKILL.md) (Phase 4 reader-test prior art).
- [`skills/research-prompt-optimizer/phases/phase4-reader-test.md`](../../skills/research-prompt-optimizer/phases/phase4-reader-test.md) (canonical self-containedness audit).
...
4. The agent SHOULD author `reflection/friction-log.md` per FRUSTRATED.md FL[0-3] when frictions arise; absence of frictions MAY be recorded as `FL: 0`.
