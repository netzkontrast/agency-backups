...
- **C.4.2** The planning prompt **MUST** define the expected structure of the final report (e.g., Executive Summary, Key Findings).
...
### §6. Aspect 4 — Review
#### §6.1 Normative Statements
- **C.6.1** A review prompt **MUST** instruct Gemini to self-evaluate its report for hallucinated claims.
...
### §7. Aspect 5 — Validate / Verify
#### §7.1 Normative Statements
- **C.7.1** The validation prompt **MUST** require Gemini to provide clickable citations for all major claims.
