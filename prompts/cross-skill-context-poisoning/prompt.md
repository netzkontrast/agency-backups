...
## 1. Context
The SKILL.md specification allows agents to load multiple skills simultaneously. It remains undocumented how neural architectures arbitrate severe stylistic conflicts if, for example, a "Hard Sci-Fi Worldbuilder" skill and a "Comedic Romance Dialogue" skill are invoked into the same context window.
