...
1. Satisfy acceptance criterion: PRE_COMMIT.md §2 wording = FRUSTRATED.md §28 wording (modulo spec-name prefix); verified by `diff`.
2. Satisfy acceptance criterion: PRE_COMMIT.md §7.A is a three-column Legacy/Flexible/ADR table covering ≥10 tools/checks.
3. Satisfy acceptance criterion: ST-2 + ST-3 linters documented in §6.
4. Satisfy acceptance criterion: ≥4 Gherkin scenarios anchored PC.B.1-PC.B.4 land in a new acceptance section.
