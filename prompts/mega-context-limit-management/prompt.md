...
## 1. Context
The progressive disclosure model manages metadata efficiently, but the handling of a completed, continuous 100,000-word manuscript is unresolved. Some tools utilize a truncation marker to pass only the last 1,000 words. It is unknown whether this damages long-term narrative foreshadowing and character arcs.
