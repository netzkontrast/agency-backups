...
research_question_unpacked: >-
  ...
  from real sessions.
audience: maintainers authoring Task 036 + Task 037 spec amendments
...
Commit "research(readme-cadence): reconcile FRUSTRATED.md §28 with PRE_COMMIT.md §2 (Task 036 ST-1)".
Do NOT push.
```
