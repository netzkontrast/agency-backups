...
type: note
status: draft
slug: task-033-st2-tooling-self-containedness-checker
...
- `research/prompt-engineering-principle-mechanizability/output/SPEC.md` (Task 033 ST-1 output) §3 self-containedness recipe.
...
When done:
  ...
  Commit "feat(tools): prompt self-containedness checker (Task 033 ST-2, mechanizes P.5.1)".
  Do NOT push.
```
