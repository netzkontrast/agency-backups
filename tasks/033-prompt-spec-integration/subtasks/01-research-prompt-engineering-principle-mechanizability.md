...
type: note
status: draft
slug: task-033-st1-research-prompt-engineering-principle-mechanizability
...
audience: maintainer authoring PROMPT.md amendments and the new linters in Task 033
...
Commit "research(prompt-principle-mechanizability): per-principle FPR assessment (Task 033 ST-1)".
Do NOT push.
```
