...
type: index
status: active
slug: task-031-subtasks-index
summary: "Subtask index for Task 031 — AGENTS.md spec integration. Phase A (parallel): 1 research head + 3 tooling. Phase B: 1 spec amendment depending on Phase A artefacts."
created: 2026-05-06
updated: 2026-05-06
---

# Task 031 — Subtask Index
