...
type: note
status: draft
slug: task-031-st1-research-adr-corpus-extraction
...
- [`research/adr-assumption-audit/output/REPORT.md`](../../../research/adr-assumption-audit/output/REPORT.md) §2 (11 IADRs).
...
1. SPEC.md exists at `/research/adr-corpus-extraction-from-governance-specs/output/SPEC.md` with ≥15 MADR blocks.
2. Each MADR block has frontmatter compatible with the `adr_*` L2 namespace ratified by Task 027.
3. Each block cites file:line for the source clause; no synthesized clauses.
...
8. Do NOT push. Commit with message "research(adr-corpus-extraction): bootstrap ADR-0001..N extraction (Task 031 ST-1)".
```
