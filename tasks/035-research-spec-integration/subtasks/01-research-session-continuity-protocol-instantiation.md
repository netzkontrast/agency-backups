...
type: note
status: draft
slug: task-035-st1-research-session-continuity-protocol-instantiation
...
Commit "research(session-continuity): file-format instantiation of Spec-I (Task 035 ST-1)".
Do NOT push.
```
