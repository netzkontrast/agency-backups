...
- [`031-agents-spec-integration/`](./031-agents-spec-integration/) — Spec-corpus-audit-driven integration of under-cited research (adr-assumption-audit ASM-001/004/005/009, skills-skill-container-capabilities U1-U2, gemini, ncp-novel-co-authoring) into AGENTS.md; closes NO.5 narrative-ontology load discipline + §60-65 assumption-log substance enforcement gaps. Status: `open`. Subtasks: 1 research head + 3 tooling + 1 spec amendment.
- [`032-task-spec-integration/`](./032-task-spec-integration/) — Closes TASK.md §8.1 duplicate-task_id enforcement gap, formalizes §4.7 updated/abandoned boundary, back-ports skill_* L2 from skills-namespace-ontology, cross-links §3.3 to flexible-frontmatter-toolchain SPEC. Status: `open`. Subtasks: 2 research + 2 tooling + 1 spec amendment.
- [`033-prompt-spec-integration/`](./033-prompt-spec-integration/) — Adds the missing Gherkin acceptance scenarios to PROMPT.md, mechanizes engineering principles P.5.1–P.5.7 where possible, ships a framework-selection decision tree, clarifies external-research backward linkage. Status: `open`. Subtasks: 1 research + 2 tooling + 1 spec amendment.
- [`034-research-spec-integration/`](./034-research-spec-integration/) — Lifts three orphaned research outputs (agentic-eval-trust-improvement-spec, spec-driven-research-agentic-workflows, agentic-session-continuity-spec) into RESEARCH.md normative scope; mechanizes R.4.4 + R.6.5; resolves R.4.3 prompt-snapshot ambiguity. Status: `open`. Subtasks: 1 research + 3 tooling + 1 spec amendment.
- [`035-folders-spec-integration/`](./035-folders-spec-integration/) — Promotes F.5 readme.md frontmatter SHOULD→MUST, clarifies F.1.1 provider-folder exemption, adds F.6 audit-graph consistency check, lands ≥4 Gherkin scenarios. Status: `open`. Subtasks: 0 research + 2 tooling + 1 spec amendment.
- [`036-pre-commit-spec-integration/`](./036-pre-commit-spec-integration/) — Reconciles PRE_COMMIT.md §2 with FRUSTRATED.md §28, adds §7.A toolchain-precedence matrix, mechanizes PC.1.1, refactors waivers from per-file to per-rule scope. Status: `open`. Co-owned with Task 037. Subtasks: 1 research + 2 tooling + 1 spec amendment.
- [`037-frustrated-spec-integration/`](./037-frustrated-spec-integration/) — Justifies the FL0-mandatory rule with research-backed evidence, mechanically gates the FL declaration on commit, adds Gherkin acceptance criteria. Status: `open`. Co-owned with Task 036 on the §28 reconciliation. Subtasks: 1 research + 1 tooling + 1 spec amendment.
- [`038-maintenance-spec-integration/`](./038-maintenance-spec-integration/) — Operationalizes three orphaned research outputs (agentic-eval-trust-improvement-spec, repo-maintenance-protocol-spec, governance-specs-update-research §2) into MAINTENANCE.md; closes §1.1.2 toolchain-flip-criteria, §3.4 staleness algorithm, §3.5 duplicate-task_id circular dependency. Status: `open`. Subtasks: 2 research + 3 tooling + 1 spec amendment.
