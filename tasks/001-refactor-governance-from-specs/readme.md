...
- [`task.md`](./task.md) — The task spec: frontmatter, Goal, Plan, Todo, Links.

## Workflow Assumptions

- The executing prompt lives at [`/prompts/refactor-governance-from-specs/prompt.md`](../../prompts/refactor-governance-from-specs/prompt.md). It is not yet fully authored; that is Plan step 1.
- Running notes (if any) MUST be appended to a `notes.md` in this folder, not inlined into `task.md`.
- The friction log (`friction-log.md`) is created on closure per [`FRUSTRATED.md`](../../FRUSTRATED.md).
