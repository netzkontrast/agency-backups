...
type: note
status: draft
slug: task-032-st2-research-spec-staleness-decision-formalization
summary: "Subtask ST-2 (research, shared with Task 038): formalize MAINTENANCE.md §3.4 staleness decision algorithm — produce a deterministic decision tree mapping observable signals to {still accurate / drifted / completed-by-drift / no-longer-desirable}."
created: 2026-05-06
updated: 2026-05-06
---
...
None. Phase A. NOTE: Task 038 ST-2 is the *same* research subtask (cross-Task shared input). Whichever lands first authors the SPEC; the second references it.
...
Commit "research(staleness-formalization): deterministic algorithm (Task 032 ST-2 / Task 038 ST-2)".
Do NOT push.
```
