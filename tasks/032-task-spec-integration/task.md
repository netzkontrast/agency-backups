...
2. **Phase 1 — Research.** Dispatch subtask `02-research-spec-staleness-decision-formalization` (shared input with Task 038 MAINTENANCE) to formalize the §4.7 updated/abandoned boundary.
...
- [ ] 2. Dispatch subtask `02-research-spec-staleness-decision-formalization` (cross-Task input; shared with Task 038).
