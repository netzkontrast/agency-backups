...
- [`0011-codex-entrypoint-and-platform-note.md`](./0011-codex-entrypoint-and-platform-note.md) — Record Codex runtime onboarding through root `CODEX.md` plus the AGENTS.md Codex platform implementation note (`make_pr`, CR.5/CR.6 semantics). `adr_status: Proposed`.
